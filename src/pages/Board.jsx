...
const MemberCard = ({ member }) => (
  ...
  >
    ...
    <div className="relative p-4 rounded-lg bg-black/70 backdrop-blur-sm border border-white/10 h-full flex flex-col items-center justify-center">
      <img src={member.img} alt={member.name} className="w-24 h-24 rounded-full mb-3 border-2 border-white/20 object-cover" />
